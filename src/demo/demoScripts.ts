  ...
  steps: [
    {
      ...
      body: "BurgerRush is a standard food stop, stands in for any restaurant that supports carryout ordering.",
      buttonLabel: "Continue",
      placement: "left",
      emphasis: "green-flash",
    },
    ...
    ...carryoutDeterministicQualifierSteps(),
    {
      ...
      body: "Review the order when ready, select unfinished items to revisit them.",
