...
export const guidedCommerceRichIntentDemo: DemoScript = {
  ...
  steps: [
    ...
    { action: "wait-for-response", delayMs: 5000, timeoutMs: 35000 },
    {
      ...
      body: "TourBot detected core travel details and turned stray needs into a hard stay option.",
...
export const guidedCommerceAssistedCompletionDemo: DemoScript = {
  ...
  steps: [
...

    {
      ...
      body: "Dates and guest size are required. If supported, Tourbot checks availability real-time.",
      buttonLabel: "Continue",
      placement: "left",
    },
  ...
  steps: [
    {
      ...
      title: "",
      body: "BurgerRush is a standard food stop, a stand-in for any seller that supports carryout ordering.",
      buttonLabel: "Continue",
      placement: "left",
      emphasis: "green-flash",
    },
    {
      ...
      title: "",
      body: "TourBot reads customer language, responds with navigation, and action tiles.",
      buttonLabel: "Start demo",
      placement: "left",
    },
    {
