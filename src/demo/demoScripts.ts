...
export const guidedDiscoveryDemo: DemoScript = {
  ...
  steps: [
    { action: "click-target", target: "[data-demo-target='guide-open']", command: "open", hoverMs: 650, pulseMs: 560, delayMs: 850, targetWaitMs: 3600 },
    ...
    { action: "click-target", target: "[data-demo-target='guide-launcher']", command: "open", hoverMs: 650, pulseMs: 560, delayMs: 950, targetWaitMs: 3600 },
    { action: "move-pointer", target: "[data-demo-target='guide-textarea']", delayMs: 450 },
...
export const guidedCommerceRichIntentDemo: DemoScript = {
  ...
  steps: [
    ...
    { action: "click-dom-target", target: "[data-demo-target='chip-set-budget']", hoverMs: 650, pulseMs: 560, delayMs: 800, targetWaitMs: 4200 },
    { action: "click-dom-target", target: "[data-demo-target='budget-luxury']", hoverMs: 650, pulseMs: 560, delayMs: 850, targetWaitMs: 4200 },
