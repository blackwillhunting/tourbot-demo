...
function Card({
  ...
  return (
    <div
      className={`overflow-hidden rounded-[28px] border border-white/70 bg-white/92 shadow-sm shadow-slate-200/70 ring-1 ring-slate-950/[0.03] backdrop-blur ${className}`}
    >
      {children}
    </div>
  );
    ...
    <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/88 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-lg font-semibold tracking-tight">NexaPath Advisory</div>
...
function Hero({ page }: { page: Page }) {
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pb-10 pt-10">
      <div className={`relative overflow-hidden rounded-[36px] bg-gradient-to-br ${visual.gradient} px-6 py-8 text-white shadow-2xl shadow-slate-300/40 md:px-10 md:py-12`}>
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.35fr_0.85fr] lg:items-end">
          <div>
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-200">{page.hero}</p>
