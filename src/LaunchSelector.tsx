...
function DemoCard({
  ...
  return (
    <a
      href={href}
      className="group block overflow-hidden rounded-[24px] border border-white/70 bg-white/92 p-4 shadow-sm shadow-slate-200/70 ring-1 ring-slate-950/[0.03] backdrop-blur transition hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-300/40 sm:rounded-[28px] sm:p-5"
    >
      <div className="flex items-start justify-between gap-3 sm:gap-4">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          <span className="inline-flex rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-500 sm:px-3 sm:text-[11px] sm:tracking-[0.18em]">
            {modeLabel}
          </span>
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 transition group-hover:bg-slate-950 group-hover:text-white sm:h-10 sm:w-10">
      ...
      <div className="mt-4 sm:mt-5">
        ...
        <h2 className="mt-2 text-xl font-semibold tracking-tight text-slate-950 sm:text-[1.35rem]">
          {title}
        </h2>
...
export default function LaunchSelector() {
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(15,23,42,0.10),_transparent_34%),linear-gradient(135deg,_#f8fafc_0%,_#eef2ff_45%,_#f8fafc_100%)] text-slate-950">
      <header className="border-b border-white/70 bg-white/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-base font-semibold tracking-tight sm:text-lg">TourBot Demo</div>
              <div className="text-xs text-slate-500 sm:text-sm">Guided Discovery + Guided Commerce</div>
            </div>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-4 py-7 sm:px-6 sm:py-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-8 lg:py-12">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-3 py-1.5 text-xs font-medium text-slate-600 shadow-sm sm:px-4 sm:py-2 sm:text-sm">
            <Sparkles className="h-4 w-4" />
            Public launch selector
          </div>

          <h1 className="mt-4 max-w-3xl text-3xl font-semibold tracking-[-0.04em] text-slate-950 sm:text-4xl md:text-5xl">
            TourBot turns dense websites into guided conversations.
          </h1>

          <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600 sm:mt-4">
          ...
          <div className="mt-5 flex flex-col gap-3 sm:mt-6 sm:flex-row sm:flex-wrap">
            <a
              href="/discovery"
              className="inline-flex w-full items-center justify-center rounded-2xl bg-slate-950 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800 sm:w-auto"
            >
            ...
            <a
              href="/commerce"
              className="inline-flex w-full items-center justify-center rounded-2xl border border-slate-300 bg-white/80 px-4 py-2.5 text-sm font-semibold text-slate-900 shadow-sm transition hover:bg-white sm:w-auto"
            >
