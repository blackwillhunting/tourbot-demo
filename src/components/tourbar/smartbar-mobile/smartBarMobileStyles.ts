...
export function getSmartBarMobileShellStyles(isOverlay: boolean, checkoutReady: boolean) {
  ...
  const upperGlassClass = isOverlay
    ? "overflow-hidden border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.125)_0%,rgba(255,255,255,0.060)_46%,rgba(255,255,255,0.018)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.74),inset_0_-1px_4px_rgba(255,255,255,0.044),0_16px_44px_rgba(2,6,23,0.20)] ring-1 ring-white/48 backdrop-blur-[20px] backdrop-saturate-[165%]"
    : "overflow-hidden border border-white/62 bg-[linear-gradient(180deg,rgba(255,255,255,0.110)_0%,rgba(255,255,255,0.052)_46%,rgba(255,255,255,0.016)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.66),inset_0_-1px_4px_rgba(255,255,255,0.038),0_14px_40px_rgba(2,6,23,0.18)] ring-1 ring-white/42 backdrop-blur-[20px] backdrop-saturate-[165%]";
