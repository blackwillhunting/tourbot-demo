...
export function getSmartBarMobileShellStyles(isOverlay: boolean, checkoutReady: boolean) {
  ...
  const upperGlassClass = isOverlay
    ? "overflow-hidden border border-white/62 bg-[linear-gradient(180deg,rgba(255,255,255,0.026)_0%,rgba(255,255,255,0.006)_46%,rgba(255,255,255,0.000)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.66),inset_0_-1px_2px_rgba(255,255,255,0.018),0_8px_22px_rgba(2,6,23,0.10)] ring-1 ring-white/38 backdrop-blur-[4px] backdrop-saturate-[135%]"
    : "overflow-hidden border border-white/54 bg-[linear-gradient(180deg,rgba(255,255,255,0.022)_0%,rgba(255,255,255,0.005)_46%,rgba(255,255,255,0.000)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.56),inset_0_-1px_2px_rgba(255,255,255,0.016),0_7px_20px_rgba(2,6,23,0.09)] ring-1 ring-white/32 backdrop-blur-[4px] backdrop-saturate-[135%]";
