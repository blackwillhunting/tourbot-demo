...
export function getSmartBarMobileShellStyles(isOverlay: boolean, checkoutReady: boolean) {
  ...
  const upperGlassClass = isOverlay
    ? "overflow-hidden border border-white/66 bg-[linear-gradient(180deg,rgba(255,255,255,0.075)_0%,rgba(255,255,255,0.030)_46%,rgba(255,255,255,0.008)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.70),inset_0_-1px_3px_rgba(255,255,255,0.032),0_12px_34px_rgba(2,6,23,0.15)] ring-1 ring-white/42 backdrop-blur-[14px] backdrop-saturate-[155%]"
    : "overflow-hidden border border-white/58 bg-[linear-gradient(180deg,rgba(255,255,255,0.066)_0%,rgba(255,255,255,0.026)_46%,rgba(255,255,255,0.007)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.60),inset_0_-1px_3px_rgba(255,255,255,0.028),0_10px_30px_rgba(2,6,23,0.13)] ring-1 ring-white/36 backdrop-blur-[14px] backdrop-saturate-[155%]";
