...
export function getSmartBarMobileShellStyles(isOverlay: boolean, checkoutReady: boolean) {
  ...
  const upperGlassClass = isOverlay
    ? "overflow-hidden border border-white/52 bg-[linear-gradient(180deg,rgba(255,255,255,0.11)_0%,rgba(255,255,255,0.045)_46%,rgba(255,255,255,0.018)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.58),inset_0_-1px_4px_rgba(255,255,255,0.06),0_18px_56px_rgba(2,6,23,0.26)] ring-1 ring-white/34 backdrop-blur-[18px] backdrop-saturate-[190%]"
    : "overflow-hidden border border-white/46 bg-[linear-gradient(180deg,rgba(255,255,255,0.095)_0%,rgba(255,255,255,0.040)_46%,rgba(255,255,255,0.016)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.50),inset_0_-1px_4px_rgba(255,255,255,0.055),0_16px_52px_rgba(2,6,23,0.24)] ring-1 ring-white/30 backdrop-blur-[18px] backdrop-saturate-[190%]";
  const chromePillClass = isOverlay
    ? "pointer-events-auto absolute top-0 flex items-center justify-center rounded-full border border-white/52 bg-[linear-gradient(180deg,rgba(255,255,255,0.13)_0%,rgba(255,255,255,0.052)_48%,rgba(255,255,255,0.020)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.52),inset_0_-1px_3px_rgba(255,255,255,0.06),0_10px_30px_rgba(2,6,23,0.28)] ring-1 ring-white/34 backdrop-blur-[16px] backdrop-saturate-[190%] transition active:scale-[0.985]"
    : "pointer-events-auto absolute top-0 flex items-center justify-center rounded-full border border-white/46 bg-[linear-gradient(180deg,rgba(255,255,255,0.115)_0%,rgba(255,255,255,0.048)_48%,rgba(255,255,255,0.018)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.46),inset_0_-1px_3px_rgba(255,255,255,0.055),0_10px_28px_rgba(2,6,23,0.25)] ring-1 ring-white/30 backdrop-blur-[16px] backdrop-saturate-[190%] transition active:scale-[0.985]";
  const chromeIconBubbleClass = isOverlay
    ? "flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(180deg,rgba(255,255,255,0.22)_0%,rgba(255,255,255,0.060)_100%)] text-white/95 shadow-[inset_0_1px_1px_rgba(255,255,255,0.46),inset_0_-1px_3px_rgba(255,255,255,0.055),0_3px_10px_rgba(2,6,23,0.10)] ring-1 ring-white/34"
    : "flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(180deg,rgba(255,255,255,0.19)_0%,rgba(255,255,255,0.052)_100%)] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.34),inset_0_-1px_2px_rgba(255,255,255,0.045)] ring-1 ring-white/28";
