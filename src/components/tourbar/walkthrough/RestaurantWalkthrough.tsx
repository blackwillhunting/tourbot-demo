...
> = {
  tapWings: {
    ...
    status: "pending",
    label: walkthroughTooltipBeat(5)?.tooltip ?? "Make a choice",
  ...
  tapSpaghetti: {
    ...
    status: "options",
    label: walkthroughTooltipBeat(8)?.tooltip ?? "Lets review",
  ...
  tapGarstix: {
    ...
    status: "unknown",
    label: walkthroughTooltipBeat(11)?.tooltip ?? "Lets try again",
