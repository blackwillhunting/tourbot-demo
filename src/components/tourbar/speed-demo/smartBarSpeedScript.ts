...
export const SMARTBAR_FOOD_TRIO_DESKTOP_STEPS: SmartBarSpeedStep[] = [
  {
    ...
    helper: "Same desktop launch pattern, FoodTrio-specific story.",
    surface: "ordering",
    commands: [
      { kind: "shell", type: "closeAll", delayMs: 100 },
      {
        ...
        holdMs: 950,
        finalHoldMs: 1400,
        cards: ["Three food orders.", "One SmartBar."],
      },
      { kind: "focusTarget", targetId: "foodtrio-desktop-hero", label: "Three food orders", delayMs: 320 },
      {
        kind: "pointerClick",
        targetSelector: '[data-smartbar-launcher-hotspot="true"]',
        label: "",
      ...
      { kind: "shell", type: "open", delayMs: 260, settleMs: 520 },
    ],
  },
  {
    ...
    commands: [
      ...
      { kind: "focusTarget", targetId: "foodtrio-coffee-iced-vanilla-latte", label: "Modifier-heavy drink", delayMs: 520 },
      {
        kind: "typePrimary",
  ...
  },
  {
    ...
    commands: [
      ...
      { kind: "focusTarget", targetId: "foodtrio-fast-spicy-sandwich-meal", label: "Group order lane", delayMs: 520 },
      {
        kind: "typePrimary",
  ...
  },
  {
    ...
    commands: [
      ...
      { kind: "focusTarget", targetId: "foodtrio-casual-avocado-rolls", label: "Full table order", delayMs: 520 },
      {
        kind: "typePrimary",
  ...
  },
  {
    ...
    commands: [
      ...
      { kind: "shell", type: "runNextMove", delayMs: 360, settleMs: 1700 },
      {
        kind: "cards",
        mode: "standard",
        density: "normal",
