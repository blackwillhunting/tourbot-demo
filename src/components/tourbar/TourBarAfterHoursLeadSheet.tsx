...
export default function TourBarAfterHoursLeadSheet({
  ...
  if (submitted) {
    return (
      <div className="overflow-hidden rounded-3xl border border-emerald-100 bg-emerald-50/85 text-emerald-950 shadow-sm ring-1 ring-emerald-100/80">
        <div className="px-4 py-4">
          <div className="flex items-start gap-3">
            <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-emerald-600 text-white shadow-sm">
  ...
  return (
    <form
      onSubmit={submit}
      className="overflow-hidden rounded-3xl border border-amber-100 bg-amber-50/80 text-slate-950 shadow-sm ring-1 ring-amber-100/80"
    >
      ...
      <div className="space-y-2.5 px-4 py-3">
        {contextSummary && (
          <div className="rounded-2xl bg-white/75 px-3 py-2.5 text-xs leading-5 text-slate-600 ring-1 ring-amber-100">
        ...
        <label className="block">
          <span className="mb-1.5 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-slate-400">
          ...
          <input
            ...
            className="h-10 w-full rounded-2xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-amber-300 focus:ring-2 focus:ring-amber-200/70"
          />
        </label>
        ...
        <label className="block">
          ...
          <textarea
            ...
            className="max-h-32 min-h-20 w-full resize-none rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium leading-6 text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-amber-300 focus:ring-2 focus:ring-amber-200/70"
          />
        </label>
        ...
        <button
          type="submit"
          disabled={!canSubmit}
          className="group flex h-10 w-full items-center justify-center gap-2 rounded-2xl bg-slate-950 px-4 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-45"
        >
